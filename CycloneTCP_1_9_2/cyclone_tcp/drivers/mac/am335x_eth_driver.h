...
void am335xEthWriteEntry(uint32_t index, const Am335xAleEntry *entry);
void am335xEthReadEntry(uint32_t index, Am335xAleEntry *entry);

uint32_t am335xEthFindFreeEntry(void);
uint32_t am335xEthFindVlanEntry(uint32_t vlanId);
uint32_t am335xEthFindVlanAddrEntry(uint32_t vlanId, MacAddr *macAddr);

error_t am335xEthAddVlanEntry(uint32_t port, uint32_t vlanId);
error_t am335xEthAddVlanAddrEntry(uint32_t port, uint32_t vlanId, MacAddr *macAddr);
error_t am335xEthDeleteVlanAddrEntry(uint32_t port, uint32_t vlanId, MacAddr *macAddr);
