...
typedef struct
{
   ...
   uint32_t authProtocol;          ///<Allowed authentication protocols
...
typedef struct
{
   ...
   uint32_t restartCounter; ///<Restart counter
   uint32_t failureCounter; ///<Failure counter
