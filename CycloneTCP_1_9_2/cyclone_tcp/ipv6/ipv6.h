...
typedef struct
{
   ...
   uint32_t dadRetransmitCount;   ///<Retransmission counter for Duplicate Address Detection
} Ipv6AddrEntry;
...
error_t ipv6SetGlobalAddr(NetInterface *interface, uint32_t index, const Ipv6Addr *addr);
error_t ipv6GetGlobalAddr(NetInterface *interface, uint32_t index, Ipv6Addr *addr);

error_t ipv6SetAnycastAddr(NetInterface *interface, uint32_t index, const Ipv6Addr *addr);
error_t ipv6GetAnycastAddr(NetInterface *interface, uint32_t index, Ipv6Addr *addr);

error_t ipv6SetPrefix(NetInterface *interface,
   uint32_t index, const Ipv6Addr *prefix, uint32_t length);

error_t ipv6GetPrefix(NetInterface *interface,
   uint32_t index, Ipv6Addr *prefix, uint32_t *length);

error_t ipv6SetDefaultRouter(NetInterface *interface, uint32_t index, const Ipv6Addr *addr);
error_t ipv6GetDefaultRouter(NetInterface *interface, uint32_t index, Ipv6Addr *addr);

error_t ipv6SetDnsServer(NetInterface *interface, uint32_t index, const Ipv6Addr *addr);
error_t ipv6GetDnsServer(NetInterface *interface, uint32_t index, Ipv6Addr *addr);
