...
typedef struct
{
   ...
   uint32_t dupAddrDetectTransmits;                                ///<Maximum number of NS messages sent while performing DAD
   ...
   uint32_t maxRtrSolicitations;                                   ///<Number of retransmissions for RS messages
   uint32_t rtrSolicitationCount;                                  ///<Retransmission counter for RS messages
