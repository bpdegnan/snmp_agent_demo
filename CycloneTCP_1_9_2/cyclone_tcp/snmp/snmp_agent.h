...
struct _SnmpAgentContext
{
   ...
   uint32_t informRetransmitCount;                              ///<Retransmission counter
...
error_t snmpAgentSendTrap(SnmpAgentContext *context, const IpAddr *destIpAddr,
   SnmpVersion version, const char_t *userName, uint32_t genericTrapType,
   uint32_t specificTrapCode, const SnmpTrapObject *objectList, uint32_t objectListSize);
