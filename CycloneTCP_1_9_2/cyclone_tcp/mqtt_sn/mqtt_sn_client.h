...
struct _MqttSnClientContext
{
   ...
   uint32_t predefinedTopicTableSize;                   ///<Number of predefined topics
   ...
   uint32_t keepAliveCounter;                           ///<PINGREQ retransmission counter
...
error_t mqttSnClientSetPredefinedTopics(MqttSnClientContext *context,
   MqttSnPredefinedTopic *predefinedTopics, uint32_t size);
