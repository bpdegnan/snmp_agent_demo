...
error_t dhcpv6DumpOptions(const uint8_t *options, size_t length, uint32_t level)
{
   error_t error;
   size_t i;
   Dhcpv6Option *option;
...
error_t dhcpv6DumpGenericOption(const Dhcpv6Option *option, uint32_t level)
{
   //Dump contents
...
error_t dhcpv6DumpClientIdOption(const Dhcpv6Option *option, uint32_t level)
{
   //Dump contents
...
error_t dhcpv6DumpServerIdOption(const Dhcpv6Option *option, uint32_t level)
{
   //Dump contents
...
error_t dhcpv6DumpIaNaOption(const Dhcpv6Option *option, uint32_t level)
{
...
error_t dhcpv6DumpIaTaOption(const Dhcpv6Option *option, uint32_t level)
{
...
error_t dhcpv6DumpIaAddrOption(const Dhcpv6Option *option, uint32_t level)
{
...
error_t dhcpv6DumpOroOption(const Dhcpv6Option *option, uint32_t level)
{
   uint32_t i;
   uint32_t n;
   uint16_t code;
...
error_t dhcpv6DumpPreferenceOption(const Dhcpv6Option *option, uint32_t level)
{
...
error_t dhcpv6DumpElapsedTimeOption(const Dhcpv6Option *option, uint32_t level)
{
   uint32_t value;
...
error_t dhcpv6DumpRelayMessageOption(const Dhcpv6Option *option, uint32_t level)
{
   uint8_t type;
   const char_t *label;
...
error_t dhcpv6DumpAuthOption(const Dhcpv6Option *option, uint32_t level)
{
   size_t n;
...
error_t dhcpv6DumpServerUnicastOption(const Dhcpv6Option *option, uint32_t level)
{
...
error_t dhcpv6DumpStatusCodeOption(const Dhcpv6Option *option, uint32_t level)
{
   uint16_t code;
   const char_t *label;
...
error_t dhcpv6DumpRapidCommitOption(const Dhcpv6Option *option, uint32_t level)
{
   //Check the length of the option
...
error_t dhcpv6DumpUserClassOption(const Dhcpv6Option *option, uint32_t level)
{
   //Dump contents
...
error_t dhcpv6DumpVendorClassOption(const Dhcpv6Option *option, uint32_t level)
{
   //Dump contents
...
error_t dhcpv6DumpVendorSpecificInfoOption(const Dhcpv6Option *option, uint32_t level)
{
   //Dump contents
...
error_t dhcpv6DumpInterfaceIdOption(const Dhcpv6Option *option, uint32_t level)
{
   //Dump contents
...
error_t dhcpv6DumpReconfMessageOption(const Dhcpv6Option *option, uint32_t level)
{
...
error_t dhcpv6DumpReconfAcceptOption(const Dhcpv6Option *option, uint32_t level)
{
   //Check the length of the option
   if(ntohs(option->length) != 0)
      return ERROR_INVALID_OPTION;
...
error_t dhcpv6DumpDnsServersOption(const Dhcpv6Option *option, uint32_t level)
{
   uint32_t i;
   uint32_t n;
...
error_t dhcpv6DumpDomainListOption(const Dhcpv6Option *option, uint32_t level)
{
   //Dump contents
