...
static uint32_t netTaskStack[NET_TASK_STACK_SIZE];
...
error_t netAttachLinkChangeCallback(NetInterface *interface,
   LinkChangeCallback callback, void *param, uint32_t *cookie)
{
   uint32_t i;
...
error_t netDetachLinkChangeCallback(uint32_t cookie)
{
