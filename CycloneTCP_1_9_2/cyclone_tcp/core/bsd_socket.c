...
int32_t socketTranslateErrorCode(error_t error)
{
   int32_t ret;
...
int32_t bind(int32_t s, const sockaddr *addr, socklen_t addrlen)
{
   error_t error;
   uint16_t port;
   IpAddr ipAddr;
...
int32_t connect(int32_t s, const sockaddr *addr, socklen_t addrlen)
{
   error_t error;
   uint16_t port;
   IpAddr ipAddr;
...
int32_t accept(int32_t s, sockaddr *addr, socklen_t *addrlen)
{
   uint16_t port;
   IpAddr ipAddr;
   Socket *sock;
...
int32_t send(int32_t s, const void *data, size_t length, int32_t flags)
{
   error_t error;
   size_t written;
   Socket *sock;
...
int32_t sendto(int32_t s, const void *data, size_t length,
   int32_t flags, const sockaddr *addr, socklen_t addrlen)
{
   error_t error;
   size_t written;
   uint16_t port;
...
int32_t recv(int32_t s, void *data, size_t size, int32_t flags)
{
   error_t error;
   size_t received;
   Socket *sock;
...
int32_t recvfrom(int32_t s, void *data, size_t size,
   int32_t flags, sockaddr *addr, socklen_t *addrlen)
{
   error_t error;
   size_t received;
   uint16_t port;
...
int32_t getsockname(int32_t s, sockaddr *addr, socklen_t *addrlen)
{
   int32_t ret;
   Socket *sock;
...
int32_t getpeername(int32_t s, sockaddr *addr, socklen_t *addrlen)
{
   int32_t ret;
   Socket *sock;
...
int32_t setsockopt(int32_t s, int32_t level, int32_t optname,
   ...
   if(optval != NULL)
   {
      ...
      if(level == SOL_SOCKET)
      {
         ...
         case SO_SNDBUF:
            ...
            if(optlen >= (socklen_t) sizeof(int32_t))
            {
...
int32_t getsockopt(int32_t s, int32_t level, int32_t optname,
...
int32_t ioctlsocket(int32_t s, uint32_t cmd, void *arg)
{
   int32_t ret;
   int32_t *val;
   Socket *sock;
...
int32_t fcntl(int32_t s, int32_t cmd, void *arg)
{
   int32_t ret;
   int32_t *flags;
   Socket *sock;
...
int32_t shutdown(int32_t s, int32_t how)
{
   error_t error;
   Socket *sock;
...
void selectFdSet(fd_set *fds, int32_t s)
{
   int32_t i;
...
void selectFdClr(fd_set *fds, int32_t s)
{
   int32_t i;
   int32_t j;
...
int32_t selectFdIsSet(fd_set *fds, int32_t s)
{
   int32_t i;
...
int32_t gethostbyname(const char_t *name, hostent *info)
{
   error_t error;
   IpAddr ipAddr;
...
int32_t inet_aton(const char_t *cp, in_addr *inp)
{
#if (IPV4_SUPPORT == ENABLED)
   error_t error;
   Ipv4Addr ipv4Addr;
...
int32_t inet_pton(int32_t af, const char_t *src, void *dst)
{
   error_t error;
...
const char_t *inet_ntop(int32_t af, const void *src, char_t *dst, socklen_t size)
{
#if (IPV4_SUPPORT == ENABLED)
   //IPv4 address?
   if(af == AF_INET)
