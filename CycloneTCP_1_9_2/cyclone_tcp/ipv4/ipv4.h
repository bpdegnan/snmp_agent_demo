...
typedef struct
{
   ...
   uint32_t state;     ///<IGMP host state
...
error_t ipv4SetHostAddrEx(NetInterface *interface, uint32_t index, Ipv4Addr addr);
error_t ipv4GetHostAddr(NetInterface *interface, Ipv4Addr *addr);
error_t ipv4GetHostAddrEx(NetInterface *interface, uint32_t index, Ipv4Addr *addr);

error_t ipv4SetSubnetMask(NetInterface *interface, Ipv4Addr mask);
error_t ipv4SetSubnetMaskEx(NetInterface *interface, uint32_t index, Ipv4Addr mask);
error_t ipv4GetSubnetMask(NetInterface *interface, Ipv4Addr *mask);
error_t ipv4GetSubnetMaskEx(NetInterface *interface, uint32_t index, Ipv4Addr *mask);

error_t ipv4SetDefaultGateway(NetInterface *interface, Ipv4Addr addr);

error_t ipv4SetDefaultGatewayEx(NetInterface *interface, uint32_t index,
   Ipv4Addr addr);

error_t ipv4GetDefaultGateway(NetInterface *interface, Ipv4Addr *addr);

error_t ipv4GetDefaultGatewayEx(NetInterface *interface, uint32_t index,
   Ipv4Addr *addr);

error_t ipv4SetDnsServer(NetInterface *interface, uint32_t index, Ipv4Addr addr);
error_t ipv4GetDnsServer(NetInterface *interface, uint32_t index, Ipv4Addr *addr);
