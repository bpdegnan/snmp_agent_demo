...
typedef uint32_t (*FtpCheckUserCallback)(FtpClientConnection *connection,
   const char_t *user);
...
typedef uint32_t (*FtpCheckPasswordCallback)(FtpClientConnection *connection,
...
typedef uint32_t (*FtpGetFilePermCallback)(FtpClientConnection *connection,
